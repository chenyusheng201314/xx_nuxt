...
<script>
  ...
  export default {
    ...
    async asyncData({store}) {
      // 获取课程列表
      let list_data = {
        url: '/manage/course_activity/course_jp_list',
        data: {
          page: 1,
          psize: 10,
          first_sort_id: '',
    ...
    methods: {
      ...
      detele_one(ind, item) {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          axios({
            method: 'post',
            url: '/manage/course_activity/course_jp_del',
      ...
      up(ind, id) {
        ...
        // 接口
        axios({
          url: '/manage/course_activity/course_jp_up',
          baseURL: that.$store.state.admin.baseUrl,
          method: 'post',
          headers: {
            token: that.$store.state.admin.token,
      ...
      down(ind, id) {
        ...
        // 接口
        axios({
          url: '/manage/course_activity/course_jp_down',
          baseURL: that.$store.state.admin.baseUrl,
          method: 'post',
          headers: {
            token: that.$store.state.admin.token,
      ...
      sure_add() {
        ...
        if (that.already_choose.join(',') === '') {
          ...
          axios({
            method: 'post',
            url: '/manage/course_activity/course_jp_add',
            baseURL: that.$store.state.admin.baseUrl,
            headers: {
              token: that.$store.state.admin.token
            },
