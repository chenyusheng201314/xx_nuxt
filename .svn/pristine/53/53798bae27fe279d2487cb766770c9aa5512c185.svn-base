   ...
   <div class="app_update_setting">
     ...
     <div class="searchFilter">
      ...
      <el-form-item class="fRight">
          <el-button   @click="add()" class="btn_create">添加导师</el-button>
...
<el-dialog :title="(saveAction=='edit'?'编辑':'添加')+'导师'" :visible.sync="dialogFormVisible">
  ...
  <el-form :model="addInfo" :rules="rules" ref="addInfo">
      ...
      <el-form-item label="所属机构" :label-width="formLabelWidth"  prop="organization_id">
        <el-select v-model="addInfo.organization_id" placeholder="请选择">
           <el-option
          v-for="it in orgInfo"
          :key="it.id"
          :label="it.title"
     ...
     <div v-on:click="setImg('photo_small')">
      <el-form-item label="导师小图" :label-width="formLabelWidth" prop="photo_small" >
         <el-upload
          ...
          <img v-if="addInfo.photo_small.value" :src="addInfo.photo_small.value" class="avatar" >
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        </el-upload>
      </el-form-item>
   </div>
   <div v-on:click="setImg('photo_big')">
      <el-form-item label="导师大图" :label-width="formLabelWidth" prop="photo_big" >
          ...
          :on-success="handleAvatarSuccess"
          :before-upload="beforeAvatarUpload">
          <img v-if="addInfo.photo_big.value" :src="addInfo.photo_big.value" class="avatar" >
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        </el-upload>
      </el-form-item>
  </div>
      <el-form-item label="导师标签" :label-width="formLabelWidth" prop="tags">
        <el-input v-model="addInfo.tags" auto-complete="off"></el-input>
      </el-form-item>
      ...
      <el-form-item label="导师详情--APP端" :label-width="formLabelWidth" prop="details_app">
      ...
      <el-form-item label="导师详情--PC端" :label-width="formLabelWidth" prop="details_web">
        <quill-editor 
      ...
      <el-form-item label="参与项目" :label-width="formLabelWidth" prop="organization_cases_ids">
         ...
         <div class="select_case_info" v-for="(item,index) in addInfo.organization_teacher_cases" :key="index">
             ...
             <div class="img"><img :src="item.organization_big_logo.value" /></div>
         </div> 
      </el-form-item>
...
<el-dialog title="查看" :visible.sync="dialogTableVisible">
  <el-form :model="addInfo"  >
     ...
     <el-form-item label="导师状态" :label-width="formLabelWidth" prop="status">
      ...
      <el-form-item label="导师小图" :label-width="formLabelWidth" prop="photo_small">
         <img :src="addInfo.photo_small.value"/>   
      </el-form-item>
      <el-form-item label="导师大图" :label-width="formLabelWidth" prop="photo_big">
         <img :src="addInfo.photo_big.value"/>   
      </el-form-item>
      <el-form-item label="导师标签" :label-width="formLabelWidth" prop="tags">
        {{addInfo.tags}}
      </el-form-item>
      <el-form-item label="导师简介" :label-width="formLabelWidth" prop="introduction">
        {{addInfo.introduction}}
      </el-form-item>
      <el-form-item label="导师擅长领域" :label-width="formLabelWidth" prop="areas_of_expertise">
        {{addInfo.areas_of_expertise}}
      </el-form-item>

      <el-form-item label="授课风格" :label-width="formLabelWidth" prop="teaching_style">
        {{addInfo.teaching_style}}
      </el-form-item>
      <el-form-item label="导师详情--APP端" :label-width="formLabelWidth" prop="details_app">
           {{addInfo.details_app}}
      </el-form-item>
...
export default {
  ...
  data () {
    return {
      rules: {
          ...
          realname_en:[{ required: true, message: '必填', trigger: 'blur' }],
          ...
          areas_of_expertise: [{ required: true, message: '必填', trigger: 'blur' }],
          tags:[{ required: true, message: '必填', trigger: 'blur' }],
          teaching_style: [{ required: true, message: '必填', trigger: 'blur' }],
      ...
      addInfo:{photo_small:{url:""},photo_big:{url:""}},   
  ...
  async asyncData({store}){
      let params = {url: "/manage/organization_teacher/list",data:{page:1,psize:10}}
  ...
  methods: {
    async selectCase() {
      ...
      let params = {url: "/manage/organization_cases/list",data:{page:1,psize:2}}
    ...
    add:function(){
        this.addInfo = {photo_small:{url:""},photo_big:{url:""},organization_cases_ids:""}
        this.saveAction = "add"
