<template>
  ...
  <div>
    <input type="file" :style="m_style" :accept="mime" id="upload" value="多文件上传" multiple/>
    ...
    <div class="up-lists-cover" v-show="cover_show">
      <div class="cover-con">
        ...
        <div class="remove-list" @click="close_cover">收起上传列表</div>
      </div>
    </div>
...
<script>
  ...
  export default {
    layout: 'admin',
    name: "up_video",
    props: ['mime', 'company_id', 'm_style', 'cover_show'],
    data() {
      return {
        vsrc: '',
        vsrc1: '',
      ...
      get_voucher: function (title, filename, filesize, cateid) {
        ...
        jQuery.ajax({
          ...
          data: {
            ...
            cateid: cateid, //YES    视频分类ID，固定值公司视频 (ID:536768796)
