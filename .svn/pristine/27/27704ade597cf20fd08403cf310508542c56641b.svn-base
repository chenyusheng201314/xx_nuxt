    ...
    <div class="case_table">
         <div class="row">
            ...
            <div class="col-md-3 " v-for="(vo, index) in updateInfo" :key="index">
              <div class="case_list">
                <img :src="vo.cases_content_picture.value"/> 
                <div class="op"><span v-on:click="ded(index)">加星</span> <span v-on:click="edit(vo.id)">编辑</span> <span v-on:click="del(vo.id)">删除</span></div>
              </div>
...
export default {
  ...
  async asyncData({store}){
      let params = {url: "/manage/organization_cases/list",data:{page:1,psize:10}}
