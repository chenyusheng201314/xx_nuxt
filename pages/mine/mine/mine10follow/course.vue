      ...
      <div class="d-inline-block online-course" v-for="(item, index) in projects" :key="index"
        ...
        <div class="text-center course-con">
          ...
          <div class="course-process">
            ...
            <div class="follow" title="取消关注" @click="not_follow(item.id)"></div>
...
<style scoped>
  .follow {
    ...
    height: 16px;
    float: right;
    background: url("/images/mine/follow.png") no-repeat center;
    background-size: contain;
    margin-left: 4px;
  }
  .follow:hover {
    background-image: url("/images/mine/follow1.png");
  }
.paging {
