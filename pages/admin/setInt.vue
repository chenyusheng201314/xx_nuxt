  ...
  <div class="admin_body_right">
     <div class="set_int">
        <div class="set_int_list">
           ...
           <el-input v-model="intDataNew[1].point" placeholder="请输入内容" v-else></el-input> 
           积分，{{intDataNew[2].rule_name}}
           <b v-if="!intData.everyDay.isEdit">{{intDataNew[2].point}}</b>
           <el-input v-model="intDataNew[2].point" placeholder="请输入内容" v-else></el-input> 
           积分，上限
           <b v-if="!intData.everyDay.isEdit">{{intDataNew[2].upper_limit_point}}</b>
           <el-input v-model="intDataNew[2].upper_limit_point" placeholder="请输入内容" v-else></el-input> 
           积分
        ...
        <div class="set_int_list">
           ...
           <el-input v-model="intDataNew[3].point" placeholder="请输入内容" v-else></el-input> 
           积分
           <div class="set_int_list_r">
           <el-button   @click="save('useMoney',[3])" class="btn_create" v-if="intData.useMoney.isEdit == true">保存</el-button>
           <el-button   @click="edit('useMoney')" class="btn_setting" v-if="intData.useMoney.isEdit == false">编辑</el-button>
         </div>
        </div>
        ...
        <div class="set_int_list">
           ...
           <el-input v-model="intDataNew[4].point" placeholder="请输入内容" v-else></el-input>
            积分， 
           {{intDataNew[5].rule_name}}
           <b v-if="!intData.invite.isEdit">{{intDataNew[5].point}}</b>
           <el-input v-model="intDataNew[5].point" placeholder="请输入内容" v-else></el-input>
             积分
       <div class="set_int_list_r">
           <el-button   @click="save('invite',[4,5])" class="btn_create" v-if="intData.invite.isEdit == true">保存</el-button>
           <el-button   @click="edit('invite')" class="btn_setting" v-if="intData.invite.isEdit == false">编辑</el-button>
         </div>
        </div>
        ...
        <div class="set_int_list">
           ...
           <el-input v-model="intDataNew[6].point" placeholder="请输入内容" v-else></el-input>
            积分，每日上限 
           <b v-if="!intData.share.isEdit">{{intDataNew[6].upper_limit_point}}</b>
           <el-input v-model="intDataNew[6].upper_limit_point" placeholder="请输入内容" v-else></el-input>
            积分
 <div class="set_int_list_r">
        ...
        <div class="set_int_list">
           ...
           <el-input v-model="intDataNew[7].point" placeholder="请输入内容" v-else></el-input>
           积分
           <div class="set_int_list_r">
           <el-button   @click="save('giveClass',[7])" class="btn_create" v-if="intData.giveClass.isEdit == true">保存</el-button>
           <el-button   @click="edit('giveClass')" class="btn_setting" v-if="intData.giveClass.isEdit == false">编辑</el-button>
         </div>
        </div>
        ...
        <div class="set_int_list">
           ...
           <el-input v-model="intDataNew[8].point" placeholder="请输入内容" v-else></el-input>
           积分,

           {{intDataNew[9].rule_name}}
           <b v-if="!intData.perfect.isEdit">{{intDataNew[9].point}}</b>
           <el-input v-model="intDataNew[9].point" placeholder="请输入内容" v-else></el-input>
           积分
           <div class="set_int_list_r">
