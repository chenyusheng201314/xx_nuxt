         ...
         <div class="row">
            ...
            <div class="col-md-3 " v-for="(vo, index) in updateInfo" :key="index">
              <div class="case_list">
                ...
                <div class="op"><span v-on:click="edit(vo.id)">编辑</span> <span v-on:click="statusChange(vo.id)">下架</span></div>
              </div>
     ...
     <div class="training_table">
         <div class="row">
            ...
            <div class="col-md-3 " v-for="(vo, index) in updateInfo" :key="index">
              <div class="case_list">
                <img :src="vo.training_cover_pc.value"/> 
                <div class="op"><span v-on:click="edit(vo.id)">编辑</span> <span v-on:click="del(index)">下架</span></div>
              </div>
              <div class="case_title">{{vo.training_name}}</div>
            </div>
...
export default {
  ...
  data () {
    return {
      addInfo:{map_num:1,stage_count:'',stage_content:[],training_cover_app:{},training_cover_pc:{}},
  ...
  methods: {
    ...
    add:function(){
        ...
        this.saveAction = "add"
        this.addInfo = {map_num:1,stage_count:'',stage_content:[],training_cover_app:{},training_cover_pc:{}}
