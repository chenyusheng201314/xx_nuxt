<template>
   ...
   <div class="app_index_setting">
     <div class="admin_setting_title">
       ...
       <div class="btn" data-toggle="modal" data-target="#myModal" v-on:click="addM">
     ...
     <div class="banner_info" v-for="(banner, index) in sortBannerInfo" :key="index" v-dragging="{ item: banner, list: sortBannerInfo, group: 'banner' }">
         ...
         <div class="banner_sort">
           ...
           <img src="/admin/images/app_index_down.png" v-on:click="setSortDown(index)" v-if="indexInfo.bannerInfo.length!=(index+1)" /> 
         </div>
         </div>
    ...
    <div class="app_index_setting_btn">
     ...
     <el-dialog title="选择导师" :visible.sync="dialogTchVisible">
          <selectTch 
          v-on:editSuccess="editSuccess"/>
      </el-dialog>
      <el-dialog title="选择训练营" :visible.sync="dialogTrainingVisible">
          <selectTraining 
          v-on:editSuccess="editSuccess"/>
      </el-dialog>
