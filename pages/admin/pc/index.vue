      ...
      <div class="cover-con">
        ...
        <ul class="edit-detail">
          ...
          <li>
            ...
            <el-select v-model="blog_con.jg_id" placeholder="请选择" class="m-r-15" :disabled="cover_type === 2">
              <el-option
            ...
            <el-select v-model="blog_con.teacher_id" placeholder="请选择" :disabled="cover_type === 2">
              <el-option
